...
let s:gb.dark0_hard  = ['#151515', 234]     " 29-32-33
...
let s:gb.tamfolds    = ['#F5ECEB', 223]     " 235-219-178

"let s:gb.bright_red     = ['#fb4934', 167]     " 251-73-52
"let s:gb.bright_green   = ['#C97270', 142]     " 184-187-38
"let s:gb.bright_yellow  = ['#fabd2f', 214]     " 250-189-47
"let s:gb.bright_blue    = ['#83a598', 109]     " 131-165-152
"let s:gb.bright_purple  = ['#E77392', 175]     " 211-134-155
"let s:gb.bright_aqua    = ['#8ec07c', 108]     " 142-192-124
"let s:gb.bright_orange  = ['#fe8019', 208]     " 254-128-25

"let s:gb.neutral_red    = ['#cc241d', 124]     " 204-36-29
"let s:gb.neutral_green  = ['#C97270', 106]     " 152-151-26
"let s:gb.neutral_yellow = ['#d79921', 172]     " 215-153-33
"let s:gb.neutral_blue   = ['#458588', 66]      " 69-133-136
"let s:gb.neutral_purple = ['#6F873E', 132]     " 177-98-134
"let s:gb.neutral_aqua   = ['#689d6a', 72]      " 104-157-106
"let s:gb.neutral_orange = ['#d65d0e', 166]     " 214-93-14

"let s:gb.faded_red      = ['#9d0006', 88]      " 157-0-6
"let s:gb.faded_green    = ['#C97270', 100]     " 121-116-14
"let s:gb.faded_yellow   = ['#b57614', 136]     " 181-118-20
"let s:gb.faded_blue     = ['#63A098', 24]      " 7-102-120
""let s:gb.faded_blue     = ['#076678', 24]      " 7-102-120
"let s:gb.faded_purple   = ['#6F873E', 96]      " 143-63-113
"let s:gb.faded_aqua     = ['#B68806', 66]      " 66-123-88
...
call s:HL('Folded', s:gray, s:bg3, s:italic)
...
highlight CursorLine guibg=#F8EFEE
highlight CursorLineNr guibg=#F8EFEE
highlight Folded guibg=#F8EFEE
highlight VertSplit guifg=#F3EAE9 guibg=#F3EAE9
highlight PMenuSel guibg=#FFD1AD guifg=#1F1C1C
highlight PMenu guibg=#F1E5DB guifg=#1F1C1C
